...
var bill = [124, 48, 268];
var tips = [Calculator(bill[0]), Calculator(bill[1]), Calculator(bill[2])];
// console.log(tips);
console.log(
  "-----------------------------------------------------------------"
);
...
// khai key object
{
  ...
  var firstName_1 = objs.firstName,
    lastName_1 = objs.lastName;
...
//find
var methousFind = phanmangxong.findIndex(function (el) {
  return el > 4;
});
console.log("methousFind:::", methousFind);
//findIndex
var methousFindIndex = phanmangxong.find(function (el) {
  return el > 4;
});
...
// default Paramater
{
  ...
  function SmithPerson(firstName, lastName) {
    firstName === undefined
      ? (this.firstName = "Nhan khong co hahaha")
      : (this.firstName = firstName); //Cú pháp es5
  ...
  function SmithPerson1(firstName, lastName) {
    if (firstName === void 0) {
      firstName = "Nhan khong có hahaha";
    }
    this.lastName = lastName;
  }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch("".concat(proxy, "?q=").concat(this.query)),
            ];
          case 2:
            response = _a.sent();
